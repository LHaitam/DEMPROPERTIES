  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden flex flex-col justify-center px-4 pt-24 pb-12">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        {/* This wrapper simulates object-cover for iframe */}
        ...
        {/* Light cinematic overlay (NO BLACK BORDERS) */}
        <div className="absolute inset-0 bg-black/25" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/35 via-black/10 to-black/25" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-12 relative mb-14 lg:mb-28">
            <motion.h1
              ...
              className="font-oswald font-bold uppercase tracking-tighter leading-[0.85]
                         text-white text-[clamp(72px,11vw,180px)] drop-shadow-[0_25px_60px_rgba(0,0,0,0.55)]"
            >
              DEM
            </motion.h1>
            ...
            <motion.h1
              ...
              className="font-oswald font-bold uppercase tracking-tighter text-transparent bg-clip-text
                         leading-[0.85] text-[clamp(72px,11vw,180px)]
                         bg-gradient-to-r from-[#8A6930] via-[#CFA670] to-[#6F5327]
                         lg:pl-[20vw] drop-shadow-[0_25px_60px_rgba(0,0,0,0.35)]"
            >
              {t("hero.brand")}
            </motion.h1>
          </div>
          ...
          <div className="lg:col-start-8 lg:col-span-5 flex flex-col gap-10">
            <motion.p
              ...
              className="font-playfair text-xl md:text-2xl text-white/80 leading-relaxed italic
                         border-l-2 border-[#C5A059]/60 pl-6"
            >
              {t("hero.subtitle")}
            </motion.p>
            ...
            >
              <button
                ...
                className="group relative px-8 py-4 rounded-none
                           bg-white/10 backdrop-blur-md text-white
                           font-oswald uppercase tracking-widest overflow-hidden
                           border border-white/15 hover:border-[#C5A059]/60 transition-colors"
              >
              ...
              <button
                ...
                className="px-8 py-4 border border-white/25 text-white
